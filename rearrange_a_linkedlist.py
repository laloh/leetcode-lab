...
order. So if the LinkedList has nodes 1 -> 2 -> 3 -> 4 -> 5 -> 6 -> null
your method shoud return 1 -> 6 -> 2 -> 5 -> 3 -> 4 -> null
...
def reorder(head):
    ...
    # set the next of the last none to None
